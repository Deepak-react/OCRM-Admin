...
const CompanyProfile = () => {
  ...
  }, [activeTab, id, fetchUsersByCompanyId]); // Dependencies for this useEffect
...
//                         <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{user.cFull_name}</td>
//                         <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{user.cEmail}</td>
//                         <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{user.cjob_title}</td>
//                         <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
//                           {new Date(user.dCreate_dt).toLocaleDateString("en-IN", {
//                             day: "2-digit",
//                             month: "short",
...
//               </div>
//             ) : (
//               <p className="text-gray-500">No user data available for this company.</p>
//             )}
//           </div>
//         </CustomTabPanel>
